<div class="container-fluid">
    <div class="row">
        ...
        <div class="alert alert-success">
            <strong>Written Work</strong> This page records scores for Written work activities
        </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-sm" href="<?=base_url('performance_task/s_index/'.$class_info[0]->id)?>">Performance Task</a>
