    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-info">
                <strong>Performance Task</strong> This page records scores for performance task activities
            </div>
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url('subject_teach')?>" class="btn btn-outline-primary float-left"><i class="fa fa-arrow-left"></i></a>
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-success btn-sm" href="<?=base_url('written_work/s_index/'.$class_info[0]->id)?>"> Written Work</a>
                    <a class="btn btn-danger btn-sm" href="<?=base_url('quarterly_assessment/s_index/'.$class_info[0]->id)?>">Quarterly Assessment</a>
                </div>
            </div><br>
            </div>
