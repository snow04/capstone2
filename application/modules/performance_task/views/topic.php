                ...
                <div class="card-header">
                    <?php 
                        if(isset($this->session->subject_teach)){
                            echo '<a href="'.base_url('performance_task/s_index/'.$this->session->class_id).'" class="btn btn-outline-primary float-left"><i class="fa fa-arrow-left"></i></a>';
                        }else{
                            echo '<a href="'.base_url('performance_task/index/'.$this->session->class_id).'" class="btn btn-outline-primary float-left"><i class="fa fa-arrow-left"></i></a>';
                        }
                    ?>
