...
class Topic extends MY_Controller 
{
    function __construct() 
    {
        ...
        parent::__construct();
        $mdl=array(
            'quarterly_assessment/topic_model'=>'topic_mdl',
    ...
    function index($topic_id)
    {
        ...
        $data['class_info'] = $this->quarterly_assessment_mdl->classInfo($this->session->class_id);
        $data['main_content']='quarterly_assessment/topic';
