...
class Student_info extends MY_Controller 
{
    function __construct() 
    {
        ...
        parent::__construct();
        $mdl=array(
            'student_info_model'=>'student_info_mdl',
    ...
    function index($id)
    {
        ...
        $this->validate();
        $data['main_content']='student/info';
        $data['page_name']="Student Info";
        $data['student_info'] = $this->student_info_mdl->getStudent();
        
        $data['template_type']="admin";
        $data['subjects'] = array('Filipino','English','Mathematics','Science','AP','ESP','EPP','MAPEH');

        $this->load->view('includes/templates',$data);
    }

    function totalGrade($subject)
    {
        $written_work_ws =0;
        ...
        $max_score = $this->student_info_mdl->getTotal($subject, 'ww');
        $score = $this->student_info_mdl->getStudentScore($subject,'ww');
        ...
        $max_score = $this->student_info_mdl->getTotal($subject, 'pt');
        $score = $this->student_info_mdl->getStudentScore($subject,'pt');
        ...
        $max_score = $this->student_info_mdl->getTotal($subject, 'qa');
        $score = $this->student_info_mdl->getStudentScore($subject,'qa');
